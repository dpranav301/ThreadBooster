package com.thread.booster.config;
...
public class AsyncThreadPoolConfig {
    ...
    private int corePoolSize;  //This Many Threads Always Alive

    @Value("${com.cod.async.microservice.maxpoolsize:1000}")
    private int maxPoolSize;  //Upto this value no of Thread can grow
    ...
    public Executor asyncTaskExecutor() {
        ...
        executor.setThreadNamePrefix("asyncexe-");  //This is to set initial of every thread
        executor.initialize();
        return executor;
    }
}
